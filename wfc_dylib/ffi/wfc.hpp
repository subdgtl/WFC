...
enum class WfcWorldStateSlotMaskSetResult : uint32_t {
  Ok = 0,
...
WfcWorldStateInitResult wfc_world_state_init_ex(WfcWorldStateHandle *wfc_world_state_handle_ptr,
                                                ...
                                                uint16_t world_z,
                                                uint32_t features,
                                                uint32_t slot_init_value,
                                                float slot_module_weight_init_value,
                                                uint32_t slot_mask_init_value);
...
//   [`wfc_world_state_init_from`] and not yet freed via
//   [`wfc_world_state_free`].
WfcWorldStateSlotMaskSetResult wfc_world_state_slot_mask_set(WfcWorldStateHandle wfc_world_state_handle,
                                                             uint16_t pos_x,
                                                             uint16_t pos_y,
                                                             uint16_t pos_z,
                                                             uint32_t mask);
